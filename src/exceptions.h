...
namespace Exceptions
{
    ...
    #define INTERNAL_EXCEPTION_FOR_EACH_1(m, a0                     )  m(a0)
    #define INTERNAL_EXCEPTION_FOR_EACH_2(m, a0,a1                  )  m(a0) , m(a1)
    #define INTERNAL_EXCEPTION_FOR_EACH_3(m, a0,a1,a2               )  m(a0) , m(a1) , m(a2)
    #define INTERNAL_EXCEPTION_FOR_EACH_4(m, a0,a1,a2,a3            )  m(a0) , m(a1) , m(a2) , m(a3)
    #define INTERNAL_EXCEPTION_FOR_EACH_5(m, a0,a1,a2,a3,a4         )  m(a0) , m(a1) , m(a2) , m(a3) , m(a4)
    #define INTERNAL_EXCEPTION_FOR_EACH_6(m, a0,a1,a2,a3,a4,a5      )  m(a0) , m(a1) , m(a2) , m(a3) , m(a4) , m(a5)
    #define INTERNAL_EXCEPTION_FOR_EACH_7(m, a0,a1,a2,a3,a4,a5,a6   )  m(a0) , m(a1) , m(a2) , m(a3) , m(a4) , m(a5) , m(a6)
    #define INTERNAL_EXCEPTION_FOR_EACH_8(m, a0,a1,a2,a3,a4,a5,a6,a7)  m(a0) , m(a1) , m(a2) , m(a3) , m(a4) , m(a5) , m(a6) , m(a7)
    #define INTERNAL_EXCEPTION_ARGS(name) std::string name##_
    #define INTERNAL_EXCEPTION_ASSIGN(name) ret.name = name##_
    ...
    #define NEW_EXCEPTION(name, desc, field_c, ...) \
        ...
        \
        [[noreturn]] inline void name(INTERNAL_EXCEPTION_FOR_EACH_##field_c(INTERNAL_EXCEPTION_ARGS, __VA_ARGS__)) \
        { \
            name##_t ret; \
            INTERNAL_EXCEPTION_FOR_EACH_##field_c(INTERNAL_EXCEPTION_ASSIGN, __VA_ARGS__); \
